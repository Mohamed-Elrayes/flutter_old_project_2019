    ...
    return BlocConsumer<SignUpFormBloc, SignUpFormState>(
      ...
      listener: (context, state) async {
        if (state.status.isSubmissionSuccess) {
          Navigator.of(context).pushReplacementNamed(RoutesName.bottomNavPath);
...
class _SignUpAnotherMethod extends StatelessWidget {
  ...
  _handelTermAndConditiOnTap(context) => Navigator.of(context)
      .pushReplacementNamed(RoutesName.termsAndConditionPath);
  _handelBackToLoginOnTap(context) => Navigator.of(context).pop();
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        InkWell(
          onTap: () => _handelBackToLoginOnTap(context),
          child: Ink(
        ...
        Column(
          children: [
            ...
            Wrap(
              ...
              children: [
                InkWell(
                  onTap: () => _handelTermAndConditiOnTap(context),
                  child: CustomTextWidget.subTitleBold(
                    'Terms & Conditions',
                  ),
                ),
