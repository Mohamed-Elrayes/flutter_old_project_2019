...
import 'package:newsly_app/core/core.dart';
import 'package:newsly_app/logic/bloc/articles/articles_bloc.dart';
...
class ArticlesHomePage extends StatelessWidget {
  const ArticlesHomePage({Key? key}) : super(key: key);
    void onTap(int value , articleBlocState) {
      ...
      var selectedElement = kindArticles.elementAt(value);
      kindArticles.forEach((element) {
        element != selectedElement
            ? element.isSelected = false
            : element.isSelected = true;
      });
      articleBlocState
          .add(ArticlesFetch(categoryName: selectedElement.headLine));
    }
        ...
        body: NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
                  ...
                  SliverAppBar(
                    ...
                    title: CustomTabBarWidget(onTap: (index)=>onTap(index, articleBlocState)),
                  )
                ],
