...
class SettingPage extends StatelessWidget {
  const SettingPage({Key? key}) : super(key: key);
    ...
    void _handelOnChanged(context) => BlocProvider.of<ThemeCubit>(context).setUpdateAppThemeManual();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AnimationLimiter(
        child: ListView(
          children:  AnimationConfiguration.toStaggeredList(children:ListTile.divideTiles(context: context, tiles: [
            _ListTileWidget(
            ...
            BlocBuilder<ThemeCubit, ThemeState>(builder: (context, state) {
              return SwitchListTile(
                ...
                onChanged: (_)=>_handelOnChanged(context),
              );
            }),
          ...
          ]).toList(),  childAnimationBuilder: (widget) => SlideAnimation(
